...
main = do
  ...
  let alienBlock = color yellow (polygon [(-10, -20),(-15, -10),(-10, -5),(-20, 0),(-10, 10),(-5, 15),(0, 20),(10, 15),(15, 10),(20, 0),(15, -10),(10, -15),(0, -20)])
  let bulletDot = color white (circleSolid 2)
  randomNumber <- randomIO
  playIO window background 30 (initialState randomNumber) (return . view playerCircle asteroidBlock alienBlock bulletDot) input step
